...
<body>
    <div class="cover">
       <h1><center style="font-size: 150px">401</center></h1>
       <h1>عذرا <small> عذرا لا يمكنك الوصول لهذه الصفحة </small></h1>
       <p class="lead">... جارى تحويلك إلى الصفحة السابقه</p>
       <p class="lead2"><a href="{{ url()->previous() }}">... إن لم يكن المتصفح الخاص بك يدعم التحويل التلقائى أضغط هنا</a></p>

       <script !src="">
        setTimeout(function () {
            window.location.href = "{{ url()->previous() }}"; //will redirect to your blog page (an ex: blog.html)
