          ...
          <div class="container">
              <div class="errorStr">
                <img src="https://elryad.com/wp-content/themes/dakota-theme/layouts/images/logo.png" class="logo">
                  <h2> عفوا </h2> 
                  <p class="lead">... تم ايقاف الموقع لوجود مستحقات مالية غير مدفوعة</p>
                  <h1><small>برجاء الإتصال بنا على الرقم </small> 0561160160 </h1>
                  <p class="lead2"><a href="http://elryad.com/">... وشكراً</a></p>
              </div>
          </div>
      </div>
      <script !src="">
        setTimeout(function () {
            window.location.href = "http://elryad.com/"; //will redirect to your blog page (an ex: blog.html)
