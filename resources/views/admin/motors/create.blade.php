            ...
            <div class="tabbable-line">
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('motors-store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-8 col-xs-8 ">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="descrption" class="form-control" value="{{old('descrption')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-8 col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="type" class="form-control" value="{{old('type')}}">                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-8 ">
                                    <div class="input-group">
                                        ...
                                        <input type="file" name="image_car" class="form-control" value="{{old('image')}}">
                                    </div>
                                </div>
                            </div>
