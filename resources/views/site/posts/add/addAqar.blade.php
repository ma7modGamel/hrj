			...
			<div class="row">
				<div class="col-xs-12 col-md-6">
					...
					<select class="form-control" value="{{ old('cat_id') }}" name="cat_id" id="cat_id">
						<option value="#" disabled>أختر القسم المناسب</option>
...
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDqET1nIDZzMGEieGANkEF_xB1RSCkJTjk=&callback=initialize"></script>
