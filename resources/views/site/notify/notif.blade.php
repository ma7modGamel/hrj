        ...
        @foreach ($newNotf as $note)
            ...
            <li>
              ...
              <span>
                ...
                <a href="{{url('ads/'.$note->data['id'].'/'.$note->data['title'])}}" class="note_replay">{{$note->data['title']}}</a> بواسطة 
            ...
            <li>
              ...
              <span>
                ...
                <a href="{{url('ads/'.$note->data['postId'].'/'.$note->data['postTitle'])}}" class="note_replay">{{$note->data['postTitle']}}</a> 
