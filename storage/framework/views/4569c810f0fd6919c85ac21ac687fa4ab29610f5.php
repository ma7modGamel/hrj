...
<div class="singleContent">
    <div class="msgs">
        ...
        <form id="postform" enctype="multipart/form-data">
            ...
            <div class="msg <?php echo e($num % 2 != 0 ? '' : 'adv-3'); ?>">
                <?php if($msg->UserTo): ?>
                <div class="msgInfo"><a href="<?php echo e(url('conv/'.$msg->UserTo->id)); ?>" class="msgTitleDisabled">رد : <?php echo e(str_limit($msg->body,50)); ?> </a>
                    <br>
                    <input type="hidden" name="msg[]" value="<?php echo e($msg->id); ?>"><a href="<?php echo e(url('users/'.$msg->UserTo->id)); ?>" class="username"><i class="fa fa-user"></i> <?php echo e($msg->UserTo->name); ?></a>
                </div>
                <?php else: ?>
        ...
        <hr>
        <a href="<?php echo e(url('inbox')); ?>">الرسائل الوارده</a>
        <br>
    </div>
</div><br /><br />
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/workox0x/public_html/haraj/resources/views/site/messages/outbox.blade.php ENDPATH**/ ?>