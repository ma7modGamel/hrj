...
<?php $__currentLoopData = Auth::user()->Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="adv-1 <?php echo e($num % 2 != 0 ? '' : 'adv-3'); ?>">
            <div class="row">
                <div class="col-md-9">
                    <h3><a href="<?php echo e(url('ads/'.$post->id.'/'. ($post->title))); ?>"><?php echo e($post->title); ?></a></h3>
                    <div class="text">
                ...
                <div class="col-md-3">
                    <a href="<?php echo e(url('ads/'.$post->id.'/'. ($post->title))); ?>"><img src="<?php echo e(image_check_thumps(\App\UpImage::where('post_id',$post->id)->where('type','posts')->pluck('img_name')->first(),'posts')); ?>" title="<?php echo e($post->title); ?>"></a>
                </div>
            </div>
        </div>
<?php $num++; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/workox0x/public_html/haraj/resources/views/site/posts/fav.blade.php ENDPATH**/ ?>