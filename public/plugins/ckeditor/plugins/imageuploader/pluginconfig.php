...
$username = "admin"; 
$password = '1844156d4166d94387f1a4ad031ca5fa';

$useruploadfolder = "public/upload/ckeditor";
$useruploadpath = $_SERVER['DOCUMENT_ROOT'].'/'."$useruploadfolder/";
$foldershistory[] = "public/upload/ckeditor";
